...
export const GIVEAWAYS: Record<string, StoreGiveaway[]> = {
  台北市: [
    ...
    },
    {
      ...
      startTime: '抽選/購買時間 2026/09/04 11:00 - 2026/09/05 21:00',
      items: [
        { name: 'BX-00蒼龍神劍3-60F V2', url: 'https://lin.ee/uXOiPsu' },
        { name: 'BX-00 暴風天馬3-70RA', url: 'https://lin.ee/We77Mbp' },
        { name: 'BX-26獨角刺心', url: 'https://lin.ee/7kgUqT52' },
        { name: 'BX-33 皓戰猛虎', url: 'https://lin.ee/qRFGlf9' },
        { name: 'BX-45 武士魂斬', url: 'https://lin.ee/P3riTxX6' },
        { name: 'BXG-01 烈焰飛鳳S', url: 'https://lin.ee/VyTFNj0' },
        { name: 'BXG-04 銀牙烈虎S', url: 'https://lin.ee/pr1TmsN' },
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/S9EmEj5' },
      ],
    },
    {
      store: 'Fun box忠孝SOGO',
  ...
  桃園市: [
    ...
    },
    {
      ...
      startTime: '抽選/購買時間 2026/09/04 11:00 - 2026/09/05 21:00',
      items: [
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/ROliBLbp' },
        { name: 'BX-00 蒼龍神劍3-60FV2', url: 'https://lin.ee/OwzxePd' },
        { name: 'UX-20 榮耀武神LF', url: 'https://lin.ee/RujnSBq' },
        { name: 'BX-45 武士魂斬', url: 'https://lin.ee/QLAMOhI' },
        { name: 'BX-26 獨角刺心', url: 'https://lin.ee/vm60arR' },
        { name: 'BXG-01 烈焰飛鳳S', url: 'https://lin.ee/X4BJYmE' },
        { name: 'BX-10 極限衝擊戰鬥盤', url: 'https://lin.ee/TQBZtdq' },
        { name: 'BX-30 X發射器改造造型握把（黑紅）', url: 'https://lin.ee/TKjCmyP' },
      ],
    },
    {
      store: 'Funbox 中壢大江店',
      ...
      startTime: '抽選&購買時間 2026/09/04 11:00 - 2026/09/05 21:00',
      items: [{ name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/PCzoAKi' }],
    },
    {
