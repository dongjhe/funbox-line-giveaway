...
export const GIVEAWAYS: Record<string, StoreGiveaway[]> = {
  台北市: [
    ...
    },
    {
      ...
      startTime: '抽籤時間：2026/09/04 11:00~2026/09/05 20:30',
      items: [
        { name: 'BX-00 蒼龍神劍3-60F V2', url: 'https://lin.ee/oGGJp4E' },
        { name: 'CX-13 龍王閃擊', url: 'https://lin.ee/ro7BPcE' },
        { name: 'UX-20 榮耀武神', url: 'https://lin.ee/uTN2vok' },
        { name: 'UX-21 惡魔冥界改造組', url: 'https://lin.ee/ubPqswd' },
      ],
    },
    {
