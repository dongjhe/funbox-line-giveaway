...
export const GIVEAWAYS: Record<string, StoreGiveaway[]> = {
  台北市: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'CX-00 福音戰士', url: 'https://lin.ee/xpKAzF4' },
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'BX-37 雙重極限衝擊戰鬥盤 豪華組 (不能來結帳不要來抽這款)',
  ...
  新北市: [
    {
      ...
      startTime: '抽選時間：2026/09/11 11:00~2026/09/12 21:00',
      items: [
        { name: 'CX-00迪卡狂怒', url: 'https://lin.ee/vxHwgEJ' },
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/qvFWkll' },
        { name: 'BXG-01 烈焰飛鳳', url: 'https://lin.ee/VI9mzh8' },
        { name: 'BXG-04 銀牙烈虎', url: 'https://lin.ee/QMFqYQP' },
        ...
        { name: 'BX-30發射器握把（黑紅）', url: 'https://lin.ee/zchrTmH' },
        { name: 'BX-41 發射器握把（黑/透紅）', url: 'https://lin.ee/s4PeZAo' },
        { name: 'BX-45武士魂斬', url: 'https://lin.ee/rScpBY2' },
        { name: 'UX-03魔導神杖', url: 'https://lin.ee/O4jdONt' },
        { name: 'UX-21 惡魔冥界改造組', url: 'https://lin.ee/7mvOZdjy' },
        { name: 'CX-13龍王閃擊', url: 'https://lin.ee/RKDrrPj' },
      ],
    },
    {
      store: 'Funbox新店誠品店',
    ...
    },
    {
      ...
      startTime: '',
      items: [
        { name: 'CX-13 龍王閃擊 -', url: 'https://lin.ee/r7qjeyJ' },
        { name: 'BX-00 蒼龍神劍3-60F V2', url: 'https://lin.ee/RE80eJJ' },
        { name: 'UX-21 惡魔冥界改造組', url: 'https://lin.ee/WUvGVPy' },
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/TwllYG8' },
      ],
    },
    {
      store: 'FUNBOX 比漾廣場店',
      storeUrl: 'https://linevoom.line.me/user/_dQbxr4jKpXDT3BtXULflBCgU9GujoUvNaAUOOZo',
      startTime: '抽選/購買時間 2026/09/11 開店 - 2026/09/12 21:30',
      items: [],
    },
  ],
  桃園市: [
    ...
    },
    {
      ...
      items: [
        { name: 'BX-00 蒼龍神劍3-60F V2', url: 'https://lin.ee/rekxRKT' },
        { name: 'CX-13 龍王閃擊', url: 'https://lin.ee/qFprqTK' },
        { name: 'BXG-01 烈焰飛鳳S', url: 'https://lin.ee/Y0a51aC' },
        { name: 'UX-15 鮫鯊狂鱗改造組', url: 'https://lin.ee/yRVBNOi' },
        { name: 'BX-50 天堂日輪 隨機強化組', url: 'https://lin.ee/UHG80H7' },
        { name: 'BX-33 皓戰猛虎', url: 'https://lin.ee/YJPhFjd7' },
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/rpemv2a6' },
        { name: 'BX-30 X發射器改造型握把 (黑紅)', url: 'https://lin.ee/XIp6PEXJ' },
        { name: 'BX-10 極限衝擊戰鬥盤', url: 'https://lin.ee/SF93oQo' },
      ],
    },
    {
  ...
  台中市: [
    {
      ...
      startTime: '抽籤時間&使用期限 2026/09/18 11:00 - 2026/09/19 20:30',
      items: [],
    },
    {
      store: 'Funbox麗寶一期店',
    ...
    },
    {
      ...
      startTime: '',
      items: [{ name: 'BX-00 蒼龍神劍3-60F V2', url: 'https://lin.ee/OkzbQAT' }],
    },
    {
      store: 'Funbox 文心秀泰店',
      ...
      startTime: '',
      items: [
        { name: 'BXG-01 烈焰飛鳳S - 350元', url: 'https://lin.ee/6mD2tto' },
        { name: 'CX-18 腕龍鞭打 隨機強化組 - 350元', url: 'https://lin.ee/qvMphR2' },
        { name: 'BXG-04 銀牙烈虎S - 350元', url: 'https://lin.ee/oonNSI7' },
        { name: 'CX-00 新世紀福音戰士改造組 - 1395元', url: 'https://lin.ee/Wc1Xz08' },
        { name: 'UX-21 惡魔冥界改造組 - 895元', url: 'https://lin.ee/OScAZxn' },
        { name: 'BX-00 蒼龍神劍3-60F V2 - 350元', url: 'https://lin.ee/sjDTGgg' },
      ],
    },

    {
      store: 'Funbox 台中遠雄店',
      storeUrl: 'https://linevoom.line.me/user/_da-4j4bX8VxHQN54is9WglGxqo3ISQzKaJK2vA0',
      items: [
        { name: 'BX-00 蒼龍神劍3-60F V2', url: 'https://lin.ee/WmN6C1z' },
        { name: 'UX-20 榮耀武神LF', url: 'https://lin.ee/ZzDzLBD' },
        { name: 'UX-21 惡魔冥界改造組', url: 'https://lin.ee/Pq1newj' },
        { name: 'BX-35 隨機強化組Vol.04', url: 'https://lin.ee/uFJahjaA' },
        { name: 'UX-19 子彈獅鷲H', url: 'https://lin.ee/Qa181j3' },
        { name: 'CX-13 龍王閃擊', url: 'https://lin.ee/T0DFOag' },
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/YqkOJ8d' },
      ],
    },
  ],
  嘉義市: [
  ...
  高雄市: [
    ...
    },
    {
      ...
      startTime: '抽籤時間：2026/09/04 11:00~2026/09/05 20:30',
      items: [
        { name: 'UX-03 魔導神杖  295元', url: 'https://lin.ee/ors0Vjp' },
        { name: 'CX-00 迪卡狂怒FT3-60T  595元', url: 'https://lin.ee/7oKZFGm' },
      ],
    },
    {
      store: 'Funbox-漢神巨蛋店',
    ...
    },
    {
      ...
      startTime: '',
      items: [{ name: '9/11 CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/U83wsO4i' }],
    },
    {
      store: '來玩聚-新楠店',
  ...
  新竹縣: [
    {
      ...
      startTime: '抽選/購買時間 2026/09/18 11:00 - 2026/09/19 21:00',
      items: [
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/67NmxKq' },
  ...
  苗栗縣: [
    {
      ...
      startTime: '',
      items: [
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/yBN8tor' },
        { name: 'BX-00 蒼龍神劍3-60F V2', url: 'https://lin.ee/PaeExNf' },
      ],
    },
  ],
  彰化縣: [
  ...
  雲林縣: [
    {
      ...
      items: [
        ...
        { name: 'CX-00 新世紀福音戰士改造組', url: 'https://lin.ee/nrA4IEk' },
